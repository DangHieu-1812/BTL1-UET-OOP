...
public class DictionaryCommandLine extends Dictionary{
    ...
    public void dictionaryAdvanced() throws IOException {
        ...
        do {
            ...
            switch (op) {
                case 1: {
                    System.out.println("Nhập từ muốn tra: ");
                    String t = a.nextLine();
                    commandline.dictionarySearcher(t);
                    System.out.println("Nhấn phím enter để tiếp tục ");
                    continue;
                }
                case 2: {
                    commandline.showAllWords();
                ...
                case 3: {
                    ...
                    String t = a.nextLine();
                    System.out.println("Nhập nghĩa của từ muốn thêm: ");
                    String e = a.nextLine();
                ...
                case 4: {
                    System.out.println("Nhập từ muốn sửa: ");
                ...
                case 5: {
                    System.out.println("Nhập từ muốn xóa: ");
                    String word = a.nextLine();
                ...
                case 6: {
                    ...
                    System.out.println("Xuất ra file thành công!");
                    System.out.println("Nhấn phím enter để tiếp tục");
                    continue;
                }
                default: {
                    System.out.println("Yêu cầu không hợp lệ!");
                    System.out.print("Nhấn phím enter để tiếp tục");
                    a.nextLine();
                    continue;
                }
            }
